<?php
  ...
  if(isset($_POST['confirmOrder'])  && !empty($_POST['confirmOrder']))
  {
    ...
    $height = $_POST['measurement-height'];
    $mezPrice = $_POST['productPriceSaved'];
    $_SESSION['productPriceSaved'] = $mezPrice;
...
<html lang="en" class="noIE" style="padding-bottom: 60px;"><head>
    ...
    <title>
      Mezzanine Floor Kits | Fast and Easy Installation | Per square metre T – Mezzanine Direct
    </title>
...
"url":"\/products\/mezzanine-floor-kits-fast-and-easy-installation-per-square-metre-test"}</div>
      ...
      <div class="title clearfix">
        <h1 itemprop="name">Order Confirmation</h1>
...
<div class="shappify-qty-msg"></div>
                  ...
                  <form style="margin:100px;" action="./processed.php" method="post" enctype="multipart/form-data" id="confirmationForm">
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationDefault02" placeholder="Last name" value="Doe" required>
                      </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationDefault04" placeholder="email@exmaple.com" required>
                      </div>
                      <div class="col-md-4 mb-3">
                        <label for="validationDefault05">Company</label>
                        <input type="text" class="form-control" id="validationDefault05" placeholder="Company">
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                    ...
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        <div class="desc_blk_bot clearfix">
                          ...
                          <div class="price">
                            <h2 id="productPrice" class="money" itemprop="price">
                              <?php

                              if(isset($_POST['confirmOrder'])  && !empty($_POST['confirmOrder']))
                              {
                                  $mezPrice = $_SESSION['productPriceSaved'];
                      ...
                      <div class="col-md-6 mb-3">
                        <input type="submit" name="add" class="btn_c" id="addToCart" value="Confirm Order">
                      </div>
                    </div>
                  </form>
